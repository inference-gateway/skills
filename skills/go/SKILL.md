...
> by a DI container (`internal/container/container.go`). That _is_ this project's
...
> (pre-commit runs it when `internal/domain/interfaces.go` changes); for a _new_
...
**go-concurrency**, **cobra-viper**, and **go-spec-reviewer**._
